/*
  ...
  - The values [Whitw,AsianAmerican,EastAsian,SouthEastAsian,SouthAsian,MiddleEstern] on the enum `EthinicityEnum` will be removed. If these variants are still used in the database, this will fail.
